...
using WebApplicationAssets.Data;
using WebApplicationAssets.Models;
using WebApplicationAssets.ViewModels;

namespace WebApplicationAssets.Controllers
{
    public class InvestmentsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var totalValue = investments.Sum(i => i.PurchasePrice * i.Quantity);
